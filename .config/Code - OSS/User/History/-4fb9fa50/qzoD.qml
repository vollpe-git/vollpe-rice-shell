            ...
            Rectangle{ // most used app launcher 
                ...
                MouseArea{
                    ...
                    onClicked: MouseArea {
                        anchors.fill: parent
                        // onClicked: {
                        //     // 3. Controlla se è già aperto per chiuderlo, altrimenti apri
                        //     if (fastLaunchMenu.visible) {
                        //         fastLaunchMenu.close()
                        //     } else {
                        //         fastLaunchMenu.open()
                        //     }
                        // }
                    ...
                    ColumnLayout{
                        ...
                        RowLayout{
                            ...
                            MediaControlIcon{ // shuffle
                                text: "󰒟"
                                color: {
                                    if (Media.shuffle == null) return "red"
                                    if (Media.shuffle) return "green"
                                    return "blue"
                                }
                                MouseArea{
                                    anchors.fill: parent;
                            ...
                            MediaControlIcon{ // loop
                                text: ""
                                color: {
                                    if (Media.loop == null) return "red";
                                    else if (Media.loop == MprisLoopState.Track) return "green";
                                    else if (Media.loop == MprisLoopState.Playlist) return '#ff6600';
                                    else return "blue";
                                }
                                MouseArea{
                                    anchors.fill: parent;
        ...
        RowLayout { // workspaces, centro
            ...
            Repeater {
                ...
                Text {
                    ...
                    color: {
                        if(activeWs){
                            if (activeWs.focused) return "#ff0000"
                            else if (activeWs.toplevels.values.length > 0) return "#00ff00"
                        } else return "#ffffff"
                    }
                    font.bold: true
                    MouseArea {
        ...
        RowLayout{ //destra
            ...
            RowLayout{ // volume
                ...
                Text{ //icon
                    ...
                    text: {
                        ...
                        else if(Audio.volume <= 0.33) return "󰕿";
                        else if (Audio.volume <= 0.66) return "󰖀";
                        else return "󰕾";
                    }
                    MouseArea{
                        anchors.fill: parent
                ...
                Text{ // percentuale
                    ...
                    MouseArea{ // round to nearest multiple of 5
                        anchors.fill: parent
                        cursorShape: Qt.PointingHandCursor
                        onClicked: Audio.setVolume((Math.round((Audio.volume*100) / 5) * 5)/100)
                    }
                }
            ...
            Rectangle{ // bluetooth
                ...
                readonly property bool bluetoothConnected: {
                    if(!bluetoothState) return false;
                    let connected = false;
                ...
                Text{
                    ...
                    text: "󰂯"
                    color: {
                        if(parent.bluetoothConnected) return "#00FF00"; // connected
                        if(parent.bluetoothState) return "#0000FF"; // bt on
            ...
            Rectangle{ // wifi
                ...
                readonly property var mainDevice: {
                    ...
                    if(activeDevices.length > 0) return activeDevices[0];
                }
                ...
                Text{
                    ...
                    text: {
                        ...
                        if(dev){
                            if(dev.type === 2) return ""; // ethernet
                            if(dev.type === 1) return "󰖩"; // wifi
                            return "󰱓"; // altro
                        }
