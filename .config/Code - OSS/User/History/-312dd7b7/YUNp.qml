...
Singleton {
    ...
    Connections {
        ...
        function onDefaultAudioSinkChanged() {
            ...
            trackedSink= sinkTracker.objects.length > 0 ? sinkTracker.objects[0] : null
        }
    }
    ...
    property var trackedSink: sinkTracker.objects.length > 0 ? sinkTracker.objects[0] : null
