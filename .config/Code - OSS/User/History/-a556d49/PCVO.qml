        ...
        RowLayout {
            ...
            RowLayout { // sinistra
                ...
                Rectangle { // most used app launcher
                    ...
                    MouseArea {
                        ...
                        cursorShape: Qt.PointingHandCursor
                        onClicked: {
                            var globalPos = parent.mapToGlobal(0, parent.height);
            ...
            RowLayout { //destra
                ...
                Rectangle { // bluetooth
                    ...
                    Global.bluetoothPopupActive: false
                    Global.bluetoothButtonPosition: mapToGlobal(implicitWidth / 2, root.implicitHeight)
                    ...
                    MouseArea {
                        anchors.fill: parent
                        cursorShape: Qt.PointingHandCursor
                        onClicked: Global.bluetoothPopupActive = !Global.bluetoothPopupActive //bluetoothMenu.running = true// TODO bt devices menu
                    }
                }
