...
Singleton {
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: line => root.ramUsage = parseFloat(line).toFixed(1)
        }
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: line => root.cpuUsage = parseFloat(line).toFixed(1)
        }
        onExited: running = false
    }
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: line => root.diskUsage = parseFloat(line).toFixed(1)
        }
        onExited: running = false
    }
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: line => root.cpuTemp = parseFloat(line).toFixed(1)
        }
        onExited: running = false
    }
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: line => root.gpuUsage = parseFloat(line).toFixed(1)
        }
        onExited: running = false
    }
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: line => root.fps = parseInt(line)
        }
        onExited: running = false
    }
}
